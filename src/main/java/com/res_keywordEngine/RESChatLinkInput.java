...
public static String getRESChatData(String key) throws IOException {
        Map<String, String> m = setMapData().get("DataSheet");
        String value = m.get(key);
        return value;
}

//Method to retrieve grey bar
//public static String getGreyBarValue(String key) throws IOException {
//	Map<String, String> m = setMapData().get("DataSheet");
//    String 
//    return value;
//}
